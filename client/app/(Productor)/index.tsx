      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          <View>
            ...
            <Text style={styles.producerName}>Productor</Text>
          </View>
        ...
        <View style={styles.mainActions}>
          <TouchableOpacity style={styles.primaryCard}>
            <View style={styles.cardIcon}>
              <Ionicons name="add-circle" size={32} color="#D68D3B" />
            </View>
            <Text style={styles.primaryCardTitle}>Registrar Lote</Text>
          ...
          <View style={styles.secondaryActions}>
            <TouchableOpacity style={styles.secondaryCard}>
              <View style={styles.secondaryCardIcon}>
                <Ionicons name="list-outline" size={24} color="#b1762d" />
              </View>
              <Text style={styles.secondaryCardTitle}>Mis Lotes</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.secondaryCard}>
              <View style={styles.secondaryCardIcon}>
                <Ionicons name="analytics-outline" size={24} color="#b1762d" />
              </View>
              <Text style={styles.secondaryCardTitle}>Reportes</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.summarySection}>
          ...
          <View style={styles.summaryCards}>
            <View style={styles.summaryCard}>
              ...
              <Text style={styles.summaryLabel}>Lotes Registrados</Text>
            </View>
            <View style={styles.summaryCard}>
              <Text style={styles.summaryNumber}>0</Text>
