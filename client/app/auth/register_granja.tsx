...
export default function RegisterProductor() {
  ...
  const handleRegisterGranja = async () => {
    ...
    try {
      await registerRequest(name, email, password, "productor");
      ...
      const msg = err.response?.data?.message || "Error registrando granja.";
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>Registro Productor</Text>
        ...
        {/* Botón */}
        <TouchableOpacity style={styles.button} onPress={handleRegisterGranja}>
